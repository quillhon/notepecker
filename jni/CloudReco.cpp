                ...
                if (result->getTrackingRating() > 0)
                {
                    ...
                    if (newTrackable != 0)
                    {
                        ...
                        if (strcmp(result->getUniqueTargetId(), lastTargetId) != 0)
                        {
                            ...
                            snprintf(targetMetadata, CONTENT_MAX, "%d", result->getMetaData());
        ...
        JNIEnv* env, jobject obj, jint width, jint height)
{
    ...
    getProductTextureID = env->GetMethodID(activityClass, "getProductTexture", "()Lws/quill/notepeaker/Texture;");
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_ws_quill_notepeaker_CloudReco_finishTransition(JNIEnv* env, jobject obj)
{
